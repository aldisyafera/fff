...
if (isset($_POST['submit']))
{
    ...
    $sql .= "tgl_berobat  = '{$tanggal}', keluhan_pasien = '{$keluhan}', hasil_diagnosa = '{$diagnosa}', penatalaksanaan = '{$laksana}' " ;
...
<div class="main d-flex flex-column justify-content-center align-items-center">
	<div class="ubah-box p-5 shadow">
		...
		<hr>
		<div class="main">
			<form method="post" action="berobat1_ubah.php" enctype="multipart/form-data">
